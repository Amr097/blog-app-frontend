          ...
          <div login-menu="true" className="form-content form-center">
            ...
            <div login-menu="true" className="btns-container form-center">
              <button login-menu="true" className="login-button">
                ...
                {currentMenu === "Login" ? navFormData.login.btns : "Sign up"}{" "}
                with Facebook
              </button>
              <button login-menu="true" className="login-button">
                <svg
            ...
            <p login-menu="true">
              {currentMenu === "Login"
                ? navFormData.login.message
                : "Already have an account?"}{" "}
              <a
                onClick={() =>
                  menuTypeHandler.changeMenu(
                    currentMenu === "Login" ? "Signup" : "Login"
                  )
                }
                login-menu="true"
              >
                {currentMenu === "Login" ? navFormData.login.link : "Sign in"}{" "}
              </a>
            </p>
          </div>
        </form>
